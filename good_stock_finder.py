...
for x in good_tickers : wtr.writerow ([x  , (float((finviz.get_stock(x)['Price']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Quick Ratio']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Current Ratio']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Debt/Eq']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Sales Q/Q']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Gross Margin']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Profit Margin']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['ROE']).replace("%",""))) ])

wtr = csv.writer(open ((os.path.dirname(os.path.realpath(__file__)) + '/hot_tickers.csv'), 'w'), delimiter=',', lineterminator='\n')
wtr.writerow (['Ticker', 'Price', 'Quickratio', 'Current Ratio' , 'Debt/Eq' , 'Sales Q/Q', 'Gross Margin', 'Profit Margin', 'ROE'])
for x in hot_tickers : wtr.writerow ([x  , (float((finviz.get_stock(x)['Price']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Quick Ratio']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Current Ratio']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Debt/Eq']))) , (str((finviz.get_stock(ticker.replace(".","-"))['Sales Q/Q']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Gross Margin']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['Profit Margin']).replace("%",""))) , (str((finviz.get_stock(ticker.replace(".","-"))['ROE']).replace("%",""))) ])
